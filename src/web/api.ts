import type { ApiResponse, ApprovalEvidence, CellSignal, CellsData, LensId, Market, PermitEvidence, RecordDetail, SourceReport, SummaryData } from '../shared/contracts';
